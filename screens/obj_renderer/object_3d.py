...
class Object3d:
    ...
    def translate(self, pos):
        self.vertexes = np.multiply(self.vertexes, translate(pos))
        
    def scale(self, scale_to):
        self.vertexes = np.multiply(self.vertexes, scale(scale_to))
        
    def rotate_x(self, angle):
        self.vertexes = np.multiply(self.vertexes, rotate_x(angle))
        
    def rotate_y(self, angle):
        self.vertexes = np.multiply(self.vertexes, rotate_y(angle))
        
    def rotate_z(self, angle):
        self.vertexes = np.multiply(self.vertexes, rotate_z(angle))
